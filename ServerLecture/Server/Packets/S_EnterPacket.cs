...
namespace Packets
{
    ...
    {
        public override ushort ID => (ushort)PacketID.S_EnterPacket; // 패킷 아이디

        public string sender; // 들어온 사람
        ...
        public override void Deserialize(ArraySegment<byte> buffer) // 역직렬화
        {
            ...
            process += PacketUtility.TranslateString(buffer, process, out this.sender); // sender 삽입
        }
